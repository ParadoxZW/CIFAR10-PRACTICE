...
trainloader = Data.DataLoader(trainset, batch_size=1000, shuffle=True, num_workers=args.workers)
...
def train():
    ...
    optim = optim.SGD(model.parameters(), args.lr)
